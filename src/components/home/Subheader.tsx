    ...
    return(
        <div className="flex flex-col w-screen text-6xl text-white text-center">
            <div className="flex flex-col w-screen text-3xl text-center justify-center items-center gap-5">
                <div>
                    <span className="italic font-extrabold">Looking for printable coloring pages from <span className="font-extrabold animate-[pulse_6s_ease-in-out_infinite]"> your favorite movies?</span> </span> Look no further!
                </div>
                <div>
